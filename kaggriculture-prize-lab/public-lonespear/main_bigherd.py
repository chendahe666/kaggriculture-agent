...
# --- Tunables -------------------------------------------------------------
COW_MAX = 12             # leaders run 8 cows + 6 sheep and stop. Buying past
SHEEP_MAX = 3           # that reinvests every coin into livestock instead of
GOOSE_MAX = 7           # Measured 0 = 86,878, 4 = 73,579, 8 = 59,386. Geese
...
STRAWBERRY_MAX = 5     # 4 shops demand strawberry so its price CLIMBS
...
MAX_QUADRANTS = 3       # Land stopped mattering once the farm became
                        # labour-bound: 1/2/3 quadrants land within ~2% of each
                        # other. A 2-D grid put 2 quadrants + 13 hands on top.
MAX_HANDS = 13          # Hire cost is fib-SUMMED per day and climbs steeply:
