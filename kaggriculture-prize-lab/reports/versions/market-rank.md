...
- 代码：`experiments/track-market-20260911/rank/main.py`
- SHA256：`f1a7217b2599d4c26f3252b1dbf63d7e289f5853cfe53528abd6b11eb5471502`
- 基线：COK V10（完整基线哈希见 opponent-pool.json）
- 假设：逐单位价格排序能改善成交优先级。
- 方法：单因素排序叠加层，保留采购槽位约束。
- 评估：COK/Igor/lonespear × 91101/91102 × 双座位，共 12 局。
- 实际结果：10/0/2；对 COK 2/4 胜。
- 结果文件：`results/track-rank-screen.json`
