...
Specify the curve's x-axis and concrete comparison levels, not just “plot a learning
curve”; for example choose affordable simulator-call counts after measuring throughput.
Account for fitting, teacher generation, evaluation and dependent warm-start stages.
...
Follow the project's agreed release gates and the predeclared experiment scope.
A fully tested single change can be a complete scope in some contests; do not force
unrelated work to finish first. Where the user requires a whole track, honor that
requirement. Literature review or skill tests are not a strategy experiment or submission.
